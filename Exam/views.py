                        ...
                        if 2 * single_capacity < num_of_students:
                            ...
                            for each_room in all_available_rooms:
                                ...
                                if counter + room_obj.capacity > len(grouped_students):
                                    ...
                                    final[each_slot][each_room] = grouped_students[counter:counter + room_obj.capacity]
                            ...
                            for each_room in all_available_rooms:
                                ...
                                if counter + room_obj.capacity > len(grouped_students):
                                    final[each_slot][each_room] = grouped_students[counter:len(grouped_students)]
                                    counter += (len(grouped_students) - counter)
                                else:
                                    final[each_slot][each_room] = grouped_students[counter:counter + room_obj.capacity]
                                    counter += room_obj.capacity
                                #
                            ...
                            for each_room in all_available_rooms:
                                ...
                                if counter + room_obj.capacity > len(grouped_students):
                                    ...
                                    final[each_slot][each_room].extend(
                                        grouped_students[counter:counter + room_obj.capacity])
                                counter += room_obj.capacity
        ...
        if student_obj.__len__() == 1:
            ...
            for each_subject in all_subjects:
                ...
                for each_exam_room_obj in exam_room_objs:
                    student_room.extend(each_exam_room_obj.examsubjectstudentroom_set.filter(
